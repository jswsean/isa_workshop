...
???
* Introduction: a brief summary of the paper's key points and results

* Data: Data used for the paper's analysis, and when u can find the dataset

* Methodology: key institutional feature, identification strategy, estimation methods 

* Results: main results, robustness checks, and effect mechanisms 

* Conclusion: summarizing the paper findings
--

* Introduction: the paper in brief
...
* Little has been discussed about its effects on the quality of local governance

* MB looks at how an Indonesian large-scale school construction program back in 1974 has affected the quality of village governance and the provisions of public goods.

--

* How would increases in educational attainment affect local governance?
...
???
* The author's hypothesis is that INPRES school construction program will increase the educational attainment of village heads

* Better educated village heads will be able to better relocate their village budgets towards more productive budget posts, such as infrastructure constructions 

* They will also be more efficient at project management

* Taken together, this will imply that the village government will have better provision of public goods
--
...
???
* Case study of multi pre- and post-treatment periods, and staggered treatment timing.

* [On the treatment]: because INPRES program started on 1974, and village head candidates must be at least 25 years old, so the first time that INPRES cohorts will be able to run for office will be in 1992. So, the first year that a village runs its post-1992 election will be regarded as its first post-treatment period.

* I will be referring to the INPRES-cohort election as our treatment variable.

* [On the DiD strategy]: MB used DID to analyze impacts on village-level outcomes by making two types of comparisons: (1) The first comparison is made for each villages before and after they run the INPRES-cohort elections; and (2) the second comparison is made between-villages, among those who had run their first INPRES-cohort elections and those who had not.
--
...
* MB used DiD strategy to compare village-level outcomes:
  
--
  
    + Before-after INPRES-cohort elections
--
    + Those with-without INPRES-cohort elections 
    
---
# What's the result?

???
* Heterogenous effects across villages as a function of their demand for public goods: election impacts are stronger in villages with worse public good provision at baseline, where we'd expect to see higher demand for public goods
...
???
* MB only focused on Java as BPS often used inconsistent village code identifiers back in 1990s. 

* As such, the whole merging thing has to be done on **names**, not village codes. This makes the whole thing messy.  
--
...
???
* Equilibrium effect: Entry of new candidates could shift the broader electoral preference towards more educated candidates. This could happen in elections where even INPRES-cohorts didn't run as candidates in the election

* The two channels are explored by columns 5 and 6 in the Output panel. 
--
...
???
* The 2SLS specification uses as instrument the average education of the village head in neighboring villages. 
--
